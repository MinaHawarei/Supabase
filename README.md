...
- ✅ JWT verification middleware with JWKS validation and caching
- ✅ Complete CRUD operations for tasks
- ✅ File upload support (JPEG, PNG, PDF) up to 10MB
- ✅ Signed URLs for secure file access (60-second expiration)
- ✅ Authorization rules (creator/assignee based)
...
2. **Service Role Key**: Found in Project Settings → API → Service Role Key (keep this secret!)
3. **Database Connection**: Found in Project Settings → Database → Connection string
...
config/
└── services.php (Supabase configuration)

database/
├── migrations/
│   └── 2025_12_05_231343_create_tasks_table.php
└── schema.sql
...
**Built with ❤️ using Laravel 12 and Supabase**
